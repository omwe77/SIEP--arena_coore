/* ==========================================================================
   ARENA_CORE hero video defaults
   Keep optional YouTube background IDs here so app.js stays focused on runtime
   behavior. Empty ids intentionally fall back to the image-based hero.
   ========================================================================== */
...
window.ARENA_HERO_VIDEOS = Object.freeze({
  ...
  superLig: { id: 'Ic-W7eM7Xrs', title: 'Turkish Super League Best Goals' },
  ...
  copa: { id: 'RQEIQ9EYbRg', title: 'Copa America 2024 - All Goals', start: 16 }
});
